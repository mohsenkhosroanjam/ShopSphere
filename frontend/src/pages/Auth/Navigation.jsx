...
const Navigation = () => {
  ...
  return (
    <>
      ...
      >
        <div 
        className="hidden lg:flex fixed inset-y-0 left-0 flex-col justify-between p-4 text-white bg-black w-[4%] hover:w-[15%] h-[100vh] transition-all duration-300 ease-in-out z-40 group" 
        id="navigation-container"
      >
        <div className="flex flex-col justify-center space-y-8">
          {/* Navigation Links with responsive icon sizing */}
          <Link to="/" className="flex items-center hover:translate-x-2 transition-transform p-2">
            <AiOutlineHome 
              className="mr-4 transition-all duration-300 group-hover:w-6 group-hover:h-6 w-8 h-8" 
              size={26} 
            />
          ...
          <button 
            onClick={toggleTheme} 
            className="flex items-center hover:translate-x-2 transition-transform p-2"
          >
            {isDarkMode ? (
              <>
                <BsSun 
                  ...
                  size={26} 
                />
                <span className="nav-item-name text-lg ml-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">Light Mode</span>
              </>
            ) : (
              <>
                <BsMoon 
                  ...
                  size={26} 
                />
                <span className="nav-item-name text-lg ml-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">Dark Mode</span>
              </>
            )}
          </button>
        </div>
