    ...
    return (
        <ProductWrapper scrollable={true} header="" view={false}>
                    ...
                    {category.map((item,index)=>(
                        <div className=" flex items-center gap-2 flex-col flex-grow flex-shrink-0 md:basis-[15%] basis-[17%]">
                            <img onClick={()=>onclick(item.name)} src={item.imageUrl} alt="" className="cursor-pointer md:w-full md:h-full rounded-full object-cover w-24 h-20" />
